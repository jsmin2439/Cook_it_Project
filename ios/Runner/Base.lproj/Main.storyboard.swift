...
<document type="com.apple.InterfaceBuilder3.CocoaTouch.Storyboard.XIB" version="3.0" toolsVersion="32700.99.1234" targetRuntime="iOS.CocoaTouch" propertyAccessControl="none" useAutolayout="YES" useTraitCollections="YES" useSafeAreas="YES" colorMatched="YES" initialViewController="52l-qN-uG0">
    ...
    <scenes>
        ...
        <scene sceneID="jZ4-w7-UPh">
            <objects>
                <viewController id="52l-qN-uG0" customClass="RootViewController" customModule="HandLandmarker" customModuleProvider="target" sceneMemberID="viewController">
                    <view key="view" contentMode="scaleToFill" insetsLayoutMarginsFromSafeArea="NO" id="2Qh-dN-S58">
                        ...
                        <subviews>
                            ...
                            <view contentMode="scaleToFill" translatesAutoresizingMaskIntoConstraints="NO" id="z7m-k8-X4L">
                                <rect key="frame" x="0.0" y="59" width="105.66666666666667" height="45"/>
                                <color key="backgroundColor" systemColor="systemBackgroundColor"/>
                            </view>
                            <view contentMode="scaleToFill" translatesAutoresizingMaskIntoConstraints="NO" id="XfM-80-TTX">
                                <rect key="frame" x="287.66666666666669" y="59" width="105.33333333333331" height="44"/>
                                <color key="backgroundColor" systemColor="systemBackgroundColor"/>
                            </view>
                            <view contentMode="scaleToFill" translatesAutoresizingMaskIntoConstraints="NO" id="FVR-Cx-oSb">
                                <rect key="frame" x="105.66666666666669" y="59" width="182" height="44"/>
                                <subviews>
                                    <label opaque="NO" userInteractionEnabled="NO" contentMode="left" horizontalHuggingPriority="251" verticalHuggingPriority="251" text="HandLandmarker" textAlignment="natural" lineBreakMode="tailTruncation" baselineAdjustment="alignBaselines" adjustsFontSizeToFit="NO" translatesAutoresizingMaskIntoConstraints="NO" id="42E-Ov-MEY">
                                        <rect key="frame" x="39.999999999999986" y="11.666666666666671" width="142" height="21"/>
        ...
        <scene sceneID="nVP-CX-rj2">
            <objects>
                <viewController id="zgE-Xo-ZSc" customClass="BottomSheetViewController" customModule="HandLandmarker" customModuleProvider="target" sceneMemberID="viewController">
                            ...
                            <view clipsSubviews="YES" contentMode="scaleToFill" translatesAutoresizingMaskIntoConstraints="NO" id="AOI-Gh-SLK">
                                ...
                                <subviews>
                                    ...
                                    <stepper opaque="NO" contentMode="scaleToFill" horizontalHuggingPriority="750" verticalHuggingPriority="750" contentHorizontalAlignment="center" contentVerticalAlignment="center" value="0.10000000000000001" minimumValue="0.10000000000000001" maximumValue="0.80000000000000004" stepValue="0.10000000000000001" translatesAutoresizingMaskIntoConstraints="NO" id="0nH-Zx-p69">
                                        ...
                                        <connections>
                                            <action selector="minHandDetectionConfidenceStepperValueChanged:" destination="zgE-Xo-ZSc" eventType="valueChanged" id="the-t8-8nc"/>
                                        </connections>
                                    </stepper>
                                    ...
                                    <stepper opaque="NO" contentMode="scaleToFill" horizontalHuggingPriority="750" verticalHuggingPriority="750" contentHorizontalAlignment="center" contentVerticalAlignment="center" value="0.10000000000000001" minimumValue="0.10000000000000001" maximumValue="0.80000000000000004" stepValue="0.10000000000000001" translatesAutoresizingMaskIntoConstraints="NO" id="1fr-hY-4II">
                                        ...
                                        <connections>
                                            <action selector="minHandPresenceConfidenceStepperValueChanged:" destination="zgE-Xo-ZSc" eventType="valueChanged" id="fpX-XB-V9a"/>
                                        </connections>
                                    </stepper>
                    ...
                    <connections>
                        ...
                        <outlet property="minHandDetectionConfidenceValueLabel" destination="s05-yK-gXh" id="5Va-hn-CuZ"/>
                        <outlet property="minHandPresenceConfidenceStepper" destination="1fr-hY-4II" id="8pT-6m-0gG"/>
                        <outlet property="minHandPresenceConfidenceValueLabel" destination="J1Y-43-5yW" id="MMb-wQ-EMs"/>
                        ...
                        <outlet property="numHandsStepper" destination="tad-jn-O5U" id="K5T-5S-0BS"/>
                        <outlet property="numHandsValueLabel" destination="ME8-eS-OTB" id="ew6-qT-hAS"/>
        ...
        <scene sceneID="myg-br-fzT">
            <objects>
                <viewController storyboardIdentifier="CAMERA_VIEW_CONTROLLER" id="myJ-al-UoI" customClass="CameraViewController" customModule="HandLandmarker" customModuleProvider="target" sceneMemberID="viewController">
        ...
        <scene sceneID="Y0X-cv-ykk">
            <objects>
                <viewController storyboardIdentifier="MEDIA_LIBRARY_VIEW_CONTROLLER" id="NhF-T7-efv" customClass="MediaLibraryViewController" customModule="HandLandmarker" customModuleProvider="target" sceneMemberID="viewController">
                    <view key="view" contentMode="scaleToFill" id="zQB-07-hhL">
                        <rect key="frame" x="0.0" y="0.0" width="393" height="852"/>
                        <autoresizingMask key="autoresizingMask" widthSizable="YES" heightSizable="YES"/>
                        <subviews>
                            <label opaque="NO" userInteractionEnabled="NO" contentMode="left" horizontalHuggingPriority="251" verticalHuggingPriority="251" text="Click + to add an image or a video to begin running the face detection." textAlignment="center" lineBreakMode="tailTruncation" numberOfLines="0" baselineAdjustment="alignBaselines" adjustsFontSizeToFit="NO" translatesAutoresizingMaskIntoConstraints="NO" id="m31-ST-YG7">
                            ...
                            <view hidden="YES" contentMode="scaleToFill" translatesAutoresizingMaskIntoConstraints="NO" id="c8P-gU-0Bs">
                                ...
                                <subviews>
                                    <view contentMode="scaleToFill" translatesAutoresizingMaskIntoConstraints="NO" id="ZFP-fC-3QA">
                                        ...
                                        <subviews>
                                            <label opaque="NO" userInteractionEnabled="NO" contentMode="left" horizontalHuggingPriority="251" verticalHuggingPriority="251" text="Face Detection in Progress" textAlignment="center" lineBreakMode="tailTruncation" numberOfLines="0" baselineAdjustment="alignBaselines" adjustsFontSizeToFit="NO" translatesAutoresizingMaskIntoConstraints="NO" id="j6c-nz-Opy">
                            ...
                            <button opaque="NO" contentMode="scaleToFill" contentHorizontalAlignment="center" contentVerticalAlignment="center" buttonType="system" lineBreakMode="middleTruncation" translatesAutoresizingMaskIntoConstraints="NO" id="4qW-7H-Z8p">
                                <rect key="frame" x="299" y="693" width="74" height="64"/>
                                <state key="normal" title="Button"/>
