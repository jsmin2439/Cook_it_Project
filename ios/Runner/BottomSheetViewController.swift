...
/** The view controller is responsible for presenting the controls to change the meta data for the hand landmarker and updating the singleton`` DetectorMetadata`` on user input.
 */
class BottomSheetViewController: UIViewController {
  ...
  @IBOutlet weak var numHandsStepper: UIStepper!
  @IBOutlet weak var numHandsValueLabel: UILabel!
